...
document.querySelector("[data-message='optionsUserscriptsDescription']").innerHTML=document.querySelector("[data-message='optionsUserscriptsDescription']").textContent.replace("GitHub","<a href='https://github.com/StuffNoOneCaresAbout/Universal-Bypass/blob/master/injection_script.js' target='_blank'>GitHub</a>")
